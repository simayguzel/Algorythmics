...
class ScholarlyNetworkEngine(object):
    ...
    def aut_h_index(self, aut):
        return do_aut_h_index(self.data, self.sse, aut)

    def get_coauthor(self, author):
        return do_get_coauthor(self.author, self.sse)

    def coauthor_hierarchy(self, aut):
        return do_coauthor_hierarchy(self.data, self.sse, aut,)

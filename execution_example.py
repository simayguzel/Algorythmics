...
#my_sne.aut_h_index('Jason J., Saleem')
#my_sne.aut_h_index('Rui, Yan')
#my_sne.aut_h_index('Marco, Kuhrmann')
#my_sne.aut_h_index('René, Witte')
#my_sne.coauthor_hierarchy('René, Witte')
#my_sne.coauthor_hierarchy('Harald G., Klimach')
my_sne.coauthor_hierarchy('Marco, Kuhrmann')